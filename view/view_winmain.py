...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.textoHistorial.setGeometry(QtCore.QRect(210, 160, 291, 371))
        font = QtGui.QFont()
        font.setPointSize(11)
        ...
        self.botonGrafica = QtWidgets.QPushButton(parent=self.formLayoutWidget)
        self.botonGrafica.setText("")
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap("view/../logo/1F4C8_color.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.botonGrafica.setIcon(icon1)
        self.botonGrafica.setIconSize(QtCore.QSize(30, 30))
        self.botonGrafica.setObjectName("botonGrafica")
        self.formLayout.setWidget(2, QtWidgets.QFormLayout.ItemRole.LabelRole, self.botonGrafica)
